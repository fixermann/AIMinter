...
const Input = ({ placeholder, name, type, value, handleChange }) => (
  <input
    ...
    className="my-2 w-full rounded-sm p-2 outline-none bg-transparent text-white  text-sm input-box"
  />
);
            ...
            <div className="p-10 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
              ...
              {form.buttonLoading ? (
                ...
                <button
                  ...
                  className="text-white w-full mt-2 border-[1px] p-2 border-[#702CC9] hover:bg-[#702CC7] rounded-full cursor-pointer"
                >
