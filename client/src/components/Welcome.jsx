      ...
      <div className="flex mf:flex-row flex-col items-start justify-between w-10/12 md:p-20 py-8 px-4">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
          <p className="hero-title">
            Unleash Your Creativity with AI-Powered NFTs
          </p>
          ...
          {!currentAccount && (
            <button
              ...
              className="flex flex-row justify-center items-center my-5 bg-[#7C15FF] p-3 rounded-full cursor-pointer hover:bg-[#680FDA] font-sans"
            >
